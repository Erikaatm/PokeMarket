...
namespace PokeMarket.Migrations
{
    ...
    [Migration("20250601170133_updatedregisterRequestDTO2")]
    partial class updatedregisterRequestDTO2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PokeMarket.Models.Card", b =>
                {
                    ...
                    b.Property<bool>("GradeRequested")
            ...
            modelBuilder.Entity("PokeMarket.Models.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PokeMarket.Models.Trade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PokeMarket.Models.Trade", b =>
                {
                    b.HasOne("PokeMarket.Models.Card", "OfferedCard")
                        .WithMany()
                        .HasForeignKey("OfferedCardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PokeMarket.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PokeMarket.Models.Card", "RequestedCard")
                        .WithMany()
                        .HasForeignKey("RequestedCardId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PokeMarket.Models.User", "Requester")
                        .WithMany()
                        .HasForeignKey("RequesterId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("OfferedCard");
